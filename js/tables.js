...
var iptPerfil0 = document.getElementsByClassName("newIptPerfil")[0];
var iptPlaylist0 = document.getElementsByClassName("newIptPlaylist")[0];
...
var ttlPlaylistA = document.getElementsByClassName("titleAdd")[2];
var ttlImagenA = document.getElementsByClassName("titleAdd")[3];
...
var iptPerfil = document.getElementsByClassName("newIptPerfil")[1];
var iptPlaylist = document.getElementsByClassName("newIptPlaylist")[1];
...
var ttlPlaylist = document.getElementsByClassName("titleEdit")[2];
var ttlImagen = document.getElementsByClassName("titleEdit")[3];
...
divContainer.appendChild(ttlPlaylist);
divContainer.appendChild(iptPlaylist);
...
function showAdd() {
  ...
  iptPlaylist0.style.display = "block";
  save0.style.display = "block";
  ttlNombreA.innerHTML = "Nombre del artista:";
  ttlPerfilA.innerHTML = "Perfil:";
  ttlPlaylistA.innerHTML = "Playlist:";
  ttlImagenA.innerHTML = "Foto de perfil:";
}
...
function addRow() {
  ...
  row.insertCell(3).innerHTML = '<div class="divPlaylist">';
  addPlaylist();

  row.insertCell(4).innerHTML = '<div class="divEdicion">';
  addEdicion();
}
function addRowOld() {
...
function addNombre() {
  var artista = JSON.parse(localStorage.getItem("artista"));
...
function addPlaylist() {
  var artista = JSON.parse(localStorage.getItem("artista"));
  document.getElementsByClassName("divPlaylist")[contAdd - 1].innerHTML =
    artista.playlist;
}
function addEdicion() {
  // var edicion = document.getElementById("iptPlaylist");
...
function editRow(obj) {
  ...
  if (divCreate === false) {
    ...
    iptPlaylist.style.display = "block";
    save.style.display = "block";

    ttlNombre.innerHTML = "Nombre del artista:";
    ttlPerfil.innerHTML = "Perfil:";
    ttlPlaylist.innerHTML = "Playlist:";
    ttlImagen.innerHTML = "Foto de perfil:";
    divCreate = true;
...
function saveRow() {
  ...
  perfilNuevo = document.getElementsByClassName("newIptPerfil")[1];
  playlistNuevo = document.getElementsByClassName("newIptPlaylist")[1];
  ...
  if (playlistNuevo.value === null || playlistNuevo.value === "") {
    console.log("Añade un playlist!");
  } else {
    document.getElementsByClassName("divPlaylist")[index].innerHTML =
      artista.playlist;
  }
}
...
function addImg() {
  if (localStorage.getItem("artista")) {
    ...
    // console.log(artista);
    // console.log(artista.img);
    document.getElementsByClassName("divImgArt")[
      contAdd - 1
    ].style.backgroundImage = `${artista.img}`;
  }
}
...
function closeAdd() {
  ...
  iptPlaylist0.style.display = "none";
...
function closeEdit() {
  ...
  iptPlaylist.style.display = "none";
...
function guardar_localstorage() {
  ...
  var perfil = document.getElementById("iptPerfil");
  var playlist = document.getElementById("iptPlaylist");
  ...
  // arrayArt.splice(index,0, localStorage.setItem("artista", JSON.stringify(artista)));
}
